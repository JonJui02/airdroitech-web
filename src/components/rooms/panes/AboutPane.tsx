...
export function AboutPane({ caps, onToggle }: AboutPaneProps) {
  return (
    <div className="flex h-full flex-col justify-center px-[40px] py-[48px]">
      <p className="font-mono text-[12px] uppercase tracking-[0.16em] text-lime-500">
        {ABOUT_EYEBROW}
      </p>

      <h2 className="mt-[14px] max-w-[20ch] font-display text-[68px] font-bold leading-[0.98] tracking-[-0.032em] text-chrome-ink">
        {ABOUT_HEADING}
      </h2>

      <p className="mt-[24px] max-w-[60ch] text-[18px] leading-[1.66] text-chrome-body">
        {ABOUT_BODY}
      </p>

      <p className="mt-[38px] font-mono text-[11.5px] uppercase tracking-[0.16em] text-lime-500">
        Capabilities
      </p>
        ...
        {CAPABILITIES.map((name) => {
          ...
          return (
            <button
              ...
              className={`flex min-h-tap items-center justify-between gap-3 px-[20px] py-[18px] text-left font-mono text-[12.5px] uppercase tracking-[0.1em] transition-colors duration-200 ${
